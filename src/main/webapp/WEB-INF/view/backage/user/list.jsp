...
<section id="container" class="">
    ...
    <!--sidebar start-->
    <!--这里写查看信息，就是定位到那-->
    <menu:firstMenu  menuName="用户"></menu:firstMenu>
    <!--sidebar end-->
    <!--main content start-->
                    ...
                    <section class="panel">
                        <header class="panel-heading">
                            ...
                            <div class="pull-right">
                                <button class="btn  btn-warning" ><i class="icon-plus-sign"></i></button>
                            </div>
                        </header>
                        <table class="table table-striped table-advance table-hover">
                            ...
                            <tr>
                                ...
                                <th><i class="icon-bullhorn"></i> 密码</th>
                            ...
                            <c:forEach items="${list}" var="u">
                                <tr>
                                    <td><a href="#">${u.userId}</a></td>
                                    <td class="hidden-phone">${u.userName}</td>
                                    <td>${u.userPassword}</td>
                                    <td>
                                        <%--<button class="btn btn-primary btn-xs" onclick="showPermissions(${u.roleId})"><i class="icon-cog"></i></button>--%>
                                        <%--<button class="btn btn-primary btn-xs" onclick="modifyRole(${u.roleId},'${role.roleName}','${role.roleDesc}')"><i class="icon-pencil"></i></button>--%>
                                        <button class="btn btn-danger btn-xs" onclick="showModal(${u.userId})" ><i class="icon-trash "></i></button>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
...
<script>
    function showModal(roleId){
        $('#roleDelete').on('show.bs.modal', function (e) {
            $("#roleDelteForm").attr("action", basePath+"/user/delete/"+roleId);
        });
        $("#roleDelete").modal();
    }
