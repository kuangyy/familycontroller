...
<head>
    ...
    <link href="<%=path%>/resource/assets/jquery-easy-pie-chart/jquery.easy-pie-chart.css" rel="stylesheet" type="text/css" media="screen"/>
    <link rel="stylesheet" href="<%=path%>/resource/css/owl.carousel.css" type="text/css">
...
<body>
<input type ="hidden" id = "basePath"  value="${sessionScope.item_name}"  />
<section id="container" class="">
    <jsp:include page="base/baseHeader.jsp"></jsp:include>
                    ...
                    <section class="panel">
                        <div class="panel-body">
                            <a href="#" class="task-thumb">
                                <img src="<%=path%>/resource/img/avatar1.jpg" alt="">
                            </a>
                                    ...
                                    <div class="timeline-desk">
                                        <div class="panel">
                                            <div class="panel-body">
                                                ...
                                                <div class="album">
                                                    <a href="#">
                                                        <img alt="" src="<%=path%>/resource/img/sm-img-1.jpg">
                                                    </a>
                                                    <a href="#">
                                                        <img alt="" src="<%=path%>/resource/img/sm-img-2.jpg">
                                                    </a>
                                                    <a href="#">
                                                        <img alt="" src="<%=path%>/resource/img/sm-img-3.jpg">
                                                    </a>
                                                    <a href="#">
                                                        <img alt="" src="<%=path%>/resource/img/sm-img-1.jpg">
                                                    </a>
                    ...
                    <section class="panel post-wrap pro-box">
                        ...
                        <aside class="post-highlight yellow v-align">
                            <div class="panel-body text-center">
                                <div class="pro-thumb">
                                    <img src="<%=path%>/resource/img/ring.jpg" alt="">
                                </div>
                            </div>
                        </aside>
                    </section>
                                ...
                                <div class="follower">
                                    <div class="panel-body">
                                        ...
                                        <div class="follow-ava">
                                            <img src="<%=path%>/resource/img/follower-avatar.jpg" alt="">
                                        </div>
                                    </div>
                                </div>
...
<script src="<%=path%>/resource/js/jquery.sparkline.js" type="text/javascript"></script>
<script src="<%=path%>/resource/assets/jquery-easy-pie-chart/jquery.easy-pie-chart.js"></script>
<script src="<%=path%>/resource/js/owl.carousel.js" ></script>
<script src="<%=path%>/resource/js/jquery.customSelect.min.js" ></script>
<!--common script for all pages-->
<script src="<%=path%>/resource/js/common-scripts.js"></script>
<!--script for this page-->
<script src="<%=path%>/resource/js/sparkline-chart.js"></script>
<script src="<%=path%>/resource/js/easy-pie-chart.js"></script>
...
<script>
    ...
    $(function(){
        var value =  $("#basePath").val();
        $.cookie("basePath",value,{expires:7,path:'/'});
    });
